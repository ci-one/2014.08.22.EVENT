...
exports.getLocalNameTT = function (req, res) {
    var inputData = req.body;
    var sending = [];

    console.log(inputData);
    console.log(query.getLocalNameTT);

    c.query(query.getLocalNameTT, inputData)
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
...
exports.getannualNameTT = function (req, res) {
    var inputData = req.body;
    var sending = [];

    console.log(inputData);
    console.log(query.getannualNameTT);

    c.query(query.getannualNameTT, inputData)
        .on('result', function (res) {
            res.on('row', function (row) {
                sending.push(row);
            });
