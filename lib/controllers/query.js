...
//객실계약
exports.contractRoom = "update m_resort_code set is_contract='y' where room_no=?";

//숙소를 위한 지방회 리스트
exports.getLocalListforResort = "select c_local.local_id, c_local.local_name, m_resort_code.is_alloc from c_local, m_resort_code where m_resort_code.is_delete is not null and c_local.is_delete is null";
