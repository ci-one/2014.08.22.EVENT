...
//filter 교회명 필요
exports.getChurchListWithUnit = "select 연회.연회명, 지방회.지방회ID, 지방회.지방회명, 교회.교회ID, 교회.교회명 from 연회구성 join 연회 on 연회구성.연회ID = 연회.연회ID join 지방회 on 연회구성.지방회ID = 지방회.지방회ID join 교회 on 연회구성.교회ID = 교회.교회ID where 지방회.`지방회명` like concat('고양') and 연회구성.삭제여부 is null;"

//exports.getLocalNameTT = "select m_church_unit.annual_id, m_church_unit.local_id, m_church_unit.church_id from m_church_unit where m_church_unit.local_id= :localName ";
//exports.getLocalNameTT = "select m_church_unit.annual_id, m_church_unit.local_id, m_church_unit.church_id, c_church.church_name from m_church_unit join c_church where m_church_unit.local_id= :localName  and m_church_unit.church_id=c_church.church_id";
exports.getLocalNameTT = "select m_church_unit.annual_id, m_church_unit.local_id, m_church_unit.church_id, c_church.church_name, c_church.church_img from m_church_unit join c_church where m_church_unit.local_id= :localName  and m_church_unit.church_id=c_church.church_id";

exports.getannualNameTT="select c_local.local_id,c_local.local_name,c_local.local_img from c_local;"
